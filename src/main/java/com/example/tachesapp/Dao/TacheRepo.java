...
public interface TacheRepo extends JpaRepository<Tache,Long> {
    ...
    List<Tache> findAllByIsmemoireAndStatutNotIn(boolean ismemoire, List<String> excludedStatuts);

    List<Tache> findAllByRecepteurAndIsmemoireAndStatutNotIn(Utilisateur utilisateursList, boolean ismemoire, List<String> excludedStatuts);
